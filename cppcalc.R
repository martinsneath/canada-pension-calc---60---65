...
# number of contributory months
# assuming applying for oct
...
gd=round(.17*ncm)
# remember to look at child years from 1984 - 1993 for kids if spouse doesn't file
...
# child dropout - i am not eligible - did not get family allowance cheque
# read spreadsheet of pensionable earnings, birth, retirement start, % cola and expected pension
